...
public class RcyProductsPartnerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{

    TinyDB tinyDB;
    List<ModelProductPartnerDatum> mMainGridList;
    Context mContext;


    public RcyProductsPartnerAdapter(List<ModelProductPartnerDatum> songsList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        final ModelProductPartnerDatum catrgory  = mMainGridList.get(position);
